  ...
  var cbzx=$.fn.zTree.getZTreeObj("dept"),
            ...
            table.render({
                ...
                , cols: [[ //表头
                    ...
                    , { field: 'ANLKL', width: 86, title: '资产分类' }
                    , { field: 'TXK20', width: 162, title: '资产类别名' }
                    , { field: 'KOSTL', width: 109, title: '成本中心' }
                    , { field: 'KTEXT', width: 185, title: '成本中心描述' }
                    , { field: 'LIFNR', width: 94, title: '供应商代码' }
                    , { field: 'NAME1', width: 199, title: '供应商名称' }
                    , { field: 'ZRZRQ', width: 103, title: '入账日期' }
                    , { field: 'AFABG', width: 103, title: '使用日期' }
                    , { field: 'DEAKT', width: 103, title: '不活动日期' }
                    , { field: 'STORT', width: 86, title: '资产地点' }
                    , { field: 'MENGE', width: 86, title: '数量' }
                    , { field: 'ZZCYZ', width: 104, title: '资产原值' }
                    , { field: 'ZLJZJ', width: 98, title: '累计折旧' }
                    , { field: 'ZDQZJ', width: 90, title: '当期折旧' }
                    , { field: 'ZSYSM', width: 144, title: '计划使用寿命（月）' }
                    , { field: 'ZYSYSM', width: 144, title: '已使用寿命（月）' }
                    , { field: 'ZSYSYSM', width: 144, title: '剩余使用寿命（月）' }
                    , { field: 'ZQCYZ', width: 98, title: '期初原值' }
                    , { field: 'ZYZZJ', width: 104, title: '原值增加' }
                    , { field: 'ZYZJS', width: 86, title: '原值减少' }
                    , { field: 'ZQMYZ', width: 104, title: '期末原值' }
                    , { field: 'ZQCYE', width: 138, title: '累计折旧期初余额' }
                    , { field: 'ZBNZJE', width: 98, title: '本年折旧额' }
                    , { field: 'ZQMLJZJ', width: 108, title: '期末累计折旧' }
                    , { field: 'ZQCJE', width: 86, title: '期初净额' }
