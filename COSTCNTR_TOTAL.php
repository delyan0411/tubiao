...
<body>
    ...
    <div class="layui-form">
      ...
      <div class="layui-form-item">
        <label class="layui-form-label" style="width: 100%;text-align: center;font-size:22px;">九洲集团成本中心汇总</label>
...
layui.use(['table'], function() {
        ...
        function search (table) {
            ...
            var url = "http://192.168.1.88:8086/handler1.ashx?t=COSTCNTR_TOTAL&I_BUKRS=" + ggdm + "&I_YEAR=" + nian +
    ...
    none: '暂无相关数据' //默认：无数据。注：该属性为 layui 2.2.5 开始新增
                ...
                ,{field: 'RACCT', width: 108, title: '科目号'}
                ,{field: 'RCNTR', width: 108, title: '成本中心'}
                ,{field: 'RCNTRTXT', width: 310, title: '成本中心描述'}
                ,{field: 'PRCTR', width: 108, title: '利润中心'}
                ,{field: 'PRCTRTXT', width: 226, title: '利润中心描述'}
                ,{field: 'RACCTTXT', width: 236, title: '文本'}
                ,{field: 'WSL', width: 109, title: '金额'}
                ]]
            });
        }
